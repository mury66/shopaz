...
class _CommerceClient implements CommerceClient {
  ...
  Future<BrandModel> getBrands() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<BrandModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'brands',
  ...
  @override
  Future<WishListResponse> addToFavourites(
    String token,
    ...
    final _options = _setStreamType<WishListResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'wishlist',
  ...
  @override
  Future<WishListResponse> removeFromFavourites(
    String productId,
    String token,
  ) async {
    final _extra = <String, dynamic>{};
  ...
  @override
  Future<CartResponse> changeProductQuantity(
    String productId,
    String token,
    Map<String, String> request,
  ) async {
  ...
  @override
  Future<CartResponse> deleteCartItem(String productId, String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'token': token};
    _headers.removeWhere((k, v) => v == null);
  ...
  @override
  Future<Map<String, String>> deleteAllCartItems(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'token': token};
    _headers.removeWhere((k, v) => v == null);
